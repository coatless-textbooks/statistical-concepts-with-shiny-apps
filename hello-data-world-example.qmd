# The Hello Data World Example {#sec-hello-world}

When we think about data, we're really starting to have a conversation about
anything that has been written down. In the words of [Mythbusters](https://youtu.be/2WFFhicVeXI?t=599):
